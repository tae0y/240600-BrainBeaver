...
import traceback
from common.pooling import shutdown_global_thread_pool, shutdown_global_process_pool
...
def main():
    ...
    try:
        ...
        #file_list = sample_file_list(file_list=file_list, bucket_size=10) #STAT: 파일 랜덤 샘플링
        #for filepath in file_list:
        #    print(filepath)
        print(f"[INFO] file_list num : {len(file_list)}")
        ...
        shutdown_global_process_pool()

        # shutdown whole python application
        os._exit(0)
